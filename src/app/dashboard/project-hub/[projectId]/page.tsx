...
export default function ProjectDetailPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      {/* Breadcrumb / Back */}
      <div className="flex items-center gap-2 text-slate-500 hover:text-slate-900 transition-colors cursor-pointer" onClick={() => router.push('/dashboard/project-hub')}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Geospatial Card */}
        <Card className="hover:border-emerald-500 hover:shadow-md transition-all cursor-pointer group" onClick={() => router.push('/dashboard/geospatial')}>
        ...
        {/* Design Studio Card */}
        <Card className="hover:border-purple-500 hover:shadow-md transition-all cursor-pointer group" onClick={() => router.push('/dashboard/design-studio')}>
            <CardHeader className="pb-2">
                <div className="flex items-center justify-between mb-2">
        ...
        {/* Virtual Studio Card */}
        <Card className="hover:border-blue-500 hover:shadow-md transition-all cursor-pointer group" onClick={() => router.push('/dashboard/virtual-studio')}>
            <CardHeader className="pb-2">
                <div className="flex items-center justify-between mb-2">
        ...
        {/* Athlete 360 Card */}
        <Card className="hover:border-orange-500 hover:shadow-md transition-all cursor-pointer group" onClick={() => router.push('/dashboard/athlete-360')}>
            <CardHeader className="pb-2">
                <div className="flex items-center justify-between mb-2">
