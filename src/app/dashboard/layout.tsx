...
const navItems = [
  ...
  { name: "Project Hub", href: "/dashboard/project-hub", icon: FolderKanban },
  { name: "Geospatial", href: "/dashboard/geospatial", icon: Map },
  { name: "Design Studio", href: "/dashboard/design-studio", icon: Box },
  { name: "Virtual Studio", href: "/dashboard/virtual-studio", icon: Video },
  { name: "Athlete 360", href: "/dashboard/athlete-360", icon: Activity },
];
